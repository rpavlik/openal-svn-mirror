...
directory can be placed in /System/Library/Frameworks/OpenAL.framework  for systemwide use or
...
framework in the al_osx/build directory which can be placed in /System/Library/Frameworks for systemwide
